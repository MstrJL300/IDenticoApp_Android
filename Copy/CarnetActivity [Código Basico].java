...
public class CarnetActivity extends AppCompatActivity implements View.OnClickListener{
    //region VALORES
    ...
    public void onClick(View view) {
        String currentUrl =
                "http://app.identico.com.co/Documento/Carnet_57_900659224/1020793149.jpg";
//        "http://app.identico.com.co/Documento/Carnet_57_900659224/80821597-1.jpg";
        ...
        Picasso.get()
                ...
                .into(imageView, new Callback.EmptyCallback() {
                    ...
                    public void onSuccess() {
                        Toast.makeText(CarnetActivity.this, "Imagen Actualizada.", Toast.LENGTH_LONG).show();
                    }

                    @Override
                    public void onError(Exception e) {
                        Toast.makeText(CarnetActivity.this, "Error Actualizando la Imagen.", Toast.LENGTH_LONG).show();
                    }
                });
    }
...
//                .load(currentUrl)
//                .into(target);
//        Log.i("MSJ2", "Borrar");//FLAG
//        foto.setImageResource(0);
//        Picasso.get().invalidate(currentUrl);
    }
